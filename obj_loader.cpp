//////////////////////////////////////////////////////////////////////////
// pobieramy z pliku obj wspó³rzêdne wierzcho³ków, normalnych, textur   //
// oraz indexy. Jak nie ma w pliku wspó³rzêdnych normalnych, to na      //
// podstaie vetrexów zostaj¹ one wygenerowane .							//
// Wszystko jest wczytywane linia po lini, a nastêpnie odpowiedznie     //
// wartoœci s¹ zamieniane z char na float i s¹ wrzucane do vec3 lub vec2//
// nie ma tu takich funkcji jak zczytywanie pliku mtl, rozru¿niania     //
// wieloobiektowoœci pliku, handlerów do textur itd, ale to bêdzie      //
// w nastêpnej wersji, oraz znajdzie siê tam generacja boxu, cylindra   //
// lub sfery dla zadanego obiektu do kolizji, oraz obliczenie           //
// wspó³rzêdnych lokalnych, by móc nim sfobodnie poruszaæ po scenie     //
//////////////////////////////////////////////////////////////////////////
